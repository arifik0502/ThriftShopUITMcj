...
if ($_SERVER['REQUEST_METHOD'] == 'POST' && isset($_POST['update_profile'])) {
    ...
    mysqli_stmt_bind_param($stmt, "sssiii", $username, $phone, $bio, $email_notif, $chat_notif, $push_notif, $user_id);
            ...
            <div class="main-content">
                ...
                <div class="profile-header">
                    <div class="profile-avatar">
                        <img src="<?php echo !empty($user['avatar']) && $user['avatar'] != 'default-avatar.jpg' ? 'uploads/avatars/' . $user['avatar'] : 'https://via.placeholder.com/100'; ?>" 
